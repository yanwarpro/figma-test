...
public enum StyleDictionaryEnum {
    ...
    public static let dark20 = 20
    public static let dark24 = 24
    public static let darkBorderPage = 60
    public static let darkColorBg = #222222
    public static let darkColorHeader = #2F2F2F
    public static let darkColorTextColor = #FFFFFF
    public static let darkHeaderOpacity = 10%
    public static let darkText = [object Object]
    public static let global20 = 20
    public static let global30 = 30
    public static let global8 = 8
    public static let globalHeader = #F9F6F6
    public static let globalLg = [object Object]
    public static let globalSm = [object Object]
    public static let lightBorderPage = 30
    public static let lightColorBg = #FFFFFF
    public static let lightColorHeader = #d5d5d5
    public static let lightColorTextColor = #222222
    public static let lightHeaderOpacity = 50%
